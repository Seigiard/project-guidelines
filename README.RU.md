...
# Гайдлайны проекта &middot; [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
...
- [Git](#git)
    ...
    - [Написание хороших сообщений к коммитам](#writing-good-commit-messages)
...
### 1.1 Некоторые правила Git
Некоторый набор правил, которые надо держать в голове:
